        ...
        <div className='w-2/12 flex flex-col shadow p-5 space-y-5 relative min-w-[150px] '>
          ...
          {edit && 
            <div className="flex flex-col">
              <button className="btn btn-sm btn-circle btn-ghost absolute right-2 -mt-1" onClick={noEdit}>✕</button>
              <p class="font-semibold mr-5 mb-3">How to Edit Tasks:</p>
              <ol class="list-decimal ml-5">
                <li>Drag tasks within the calendar to change its date.</li>
                <li>Click on the task you want to edit and change the details in the modal.</li>
              </ol>
            </div>
          }
          ...
          <dialog id="my_modal_5" className="modal">
            <div className="modal-box w-11/12 max-w-5xl">
              ...
              <div className="flex space-x-3">
                ...
                <p className="text-sm">Changing of deadline once confirmed will incur exp decuction</p>
              </div>
              <Table/>
