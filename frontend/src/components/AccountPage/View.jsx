      ...
      <ul className='mt-5 menu menu-horizontal bg-base-200 rounded-box flex space-x-3'>
        <li>
          <button className='btn shadow' onClick={Account}>
            <svg xmlns='http://www.w3.org/2000/svg' className='h-5 w-5 stroke-secondary' viewBox='0 0 24 24' fill='none' stroke='#000000' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'><path d='M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2' /><circle cx='12' cy='7' r='4' /></svg>
            Account
          </button>
        </li>
        <li>
